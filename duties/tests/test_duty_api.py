...
def common_duty():
    user = User.objects.create_user(email="admin@admin.com", password="aqw/123456")
    profile = Profile.objects.create(user=user, first_name="test first_name", last_name="test last_name")
...
class TestDutyApi:
    ...
    def test_create_duty_invalid_date_response_400_status(self, api_client, common_user):
        url = reverse("api-v1:duty-list")
        data = {
            "title": "test",
            "description": "test description",
    ...
    def test_update_duty_detail_response_200_status(self, api_client, common_duty):
        url = reverse("api-v1:duty-detail", kwargs={'pk': common_duty.id})
        data = {
            "title": "test2",
            "description": "test description2",
    ...
    def test_update_duty_detail_response_401_status_by_patch(self, api_client, common_duty):
        url = reverse("api-v1:duty-detail", kwargs={'pk': common_duty.id})
        data = {
            "title": "test2",
            "description": "test description2",
